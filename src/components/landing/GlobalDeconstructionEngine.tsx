...
export const GlobalDeconstructionEngine: React.FC<GlobalDeconstructionEngineProps> = ({
  ...
  return (
    <section className="py-16 sm:py-20 bg-[#0d0b09] border-b border-[#3a352c] relative overflow-hidden" id="global-deconstruction-engine">
      ...
      <div className="w-full max-w-[1180px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-[#2d2820]">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-[2px] bg-[#c9a227]/10 border border-[#c9a227]/30 text-[#c9a227] font-['IBM_Plex_Mono',monospace] text-[11px] font-bold uppercase tracking-wider">
              ...
              <span>Live Deconstruction Engine • Threat Intelligence Showcase</span>
            </div>
            <h2 className="font-['Fraunces',serif] text-[28px] sm:text-[34px] font-medium text-[#ede6d8] tracking-tight">
              Real-Time Email Deconstruction & Live Forensics
            </h2>
            <p className="text-[#b9af9c] text-[14px] sm:text-[15px] max-w-[65ch] leading-relaxed">
              Every email analyzed by TraceXMail is disassembled down to its RFC5322 headers, BGP routing paths, cryptographic signatures, and MIME payloads. Below is live evidence queried directly from the production database.
            </p>
          </div>

          {/* Real-time DB Telemetry Badge */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 bg-[#15120e] p-3 rounded border border-[#3a352c] font-['IBM_Plex_Mono',monospace] text-[12px]">
            <div className="flex items-center gap-2 text-[#8e8574]">
              <Database className="w-4 h-4 text-[#22c55e]" />
              <span className="text-[#ede6d8] font-bold">{dbCases.length} Cases in Database</span>
            </div>
            <span className="hidden sm:inline text-[#3a352c]">|</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="p-3 bg-[#15120e] rounded border border-[#2e2820] flex items-center justify-between">
            <div>
              <div className="text-[10.5px] font-['IBM_Plex_Mono',monospace] text-[#8e8574] uppercase">Mean Verdict Latency</div>
              <div className="text-[16px] font-mono font-bold text-[#ede6d8] mt-0.5">42ms <span className="text-[10px] text-[#4ade80] font-normal">sub-second</span></div>
            </div>
            <Cpu className="w-5 h-5 text-[#c9a227]/70" />
          </div>
          <div className="p-3 bg-[#15120e] rounded border border-[#2e2820] flex items-center justify-between">
            <div>
              <div className="text-[10.5px] font-['IBM_Plex_Mono',monospace] text-[#8e8574] uppercase">Cryptographic Rigor</div>
              <div className="text-[16px] font-mono font-bold text-[#ede6d8] mt-0.5">RSA-2048 <span className="text-[10px] text-[#7fa3ba] font-normal">verified</span></div>
            </div>
            <Fingerprint className="w-5 h-5 text-[#7fa3ba]" />
          </div>
          <div className="p-3 bg-[#15120e] rounded border border-[#2e2820] flex items-center justify-between">
            <div>
              <div className="text-[10.5px] font-['IBM_Plex_Mono',monospace] text-[#8e8574] uppercase">Relay Detection</div>
              <div className="text-[16px] font-mono font-bold text-[#ede6d8] mt-0.5">Tor & VPN <span className="text-[10px] text-[#ff8d7d] font-normal">flagged</span></div>
            </div>
            <Globe className="w-5 h-5 text-[#ff8d7d]" />
          </div>
          <div className="p-3 bg-[#15120e] rounded border border-[#2e2820] flex items-center justify-between">
            <div>
              <div className="text-[10.5px] font-['IBM_Plex_Mono',monospace] text-[#8e8574] uppercase">Evidence Integrity</div>
              <div className="text-[16px] font-mono font-bold text-[#ede6d8] mt-0.5">SHA-256 <span className="text-[10px] text-[#4ade80] font-normal">sealed</span></div>
            </div>
        ...
        <div className="space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <span className="font-['IBM_Plex_Mono',monospace] text-[11px] uppercase tracking-wider text-[#8e8574] font-semibold flex items-center gap-1.5">
              ...
              <span>Filter Threat Vector Category:</span>
            </span>
            <div className="flex items-center gap-1.5 flex-wrap">
              {['ALL', 'CRITICAL BEC', 'CREDENTIAL HARVEST', 'MALWARE / TROJAN', 'CLEAN RFC'].map((cat) => (
                <button
                  ...
                  className={`px-2.5 py-1 rounded text-[10.5px] font-['IBM_Plex_Mono',monospace] font-semibold transition-all cursor-pointer border ${
                ...
                >
                  <div className="space-y-1 w-full">
                    ...
                    <h4 className="text-[13px] font-semibold text-[#ede6d8] line-clamp-2 leading-snug">
                      {c.title || c.raw_analysis?.headers?.subject || 'Forensic Mail Incident'}
                    </h4>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-[11px] font-['IBM_Plex_Mono',monospace] text-[#8e8574] pt-2 border-t border-[#2a251e]">
                    <span className="truncate max-w-[120px]">
                      {c.raw_analysis?.hops?.[0]?.city || c.origin_country || 'Direct Ingestion'}
                    </span>
        ...
        {currentCase && (
          <div className="bg-[#15120e] border border-[#3a352c] rounded-md shadow-2xl overflow-hidden">
            ...
            <div className="p-4 sm:p-5 bg-[#1a1612] border-b border-[#3a352c] flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2.5 shrink-0 flex-wrap">
                <button
                  ...
                  className="px-3 py-1.5 rounded-[2px] bg-[#221e17] hover:bg-[#2d271e] text-[#c9a227] border border-[#4a4030] font-['IBM_Plex_Mono',monospace] text-[11.5px] font-semibold transition-all cursor-pointer flex items-center gap-1.5 disabled:opacity-50"
                  title="Simulate live packet traversal through the forensic inspection pipeline"
                >
                  <Play className={`w-3 h-3 text-[#c9a227] ${isReplaying ? 'animate-spin' : ''}`} />
                  <span>{isReplaying ? 'Replaying Traversal...' : 'Replay Packet'}</span>
                </button>
                ...
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-[2px] bg-[#b23a2e] hover:bg-[#c93f31] text-[#ede6d8] font-['IBM_Plex_Mono',monospace] text-[11.5px] font-bold transition-all cursor-pointer flex items-center gap-1.5 shadow-md shrink-0"
                >
                  <span>Deconstruct in Console</span>
            ...
            {activeTab === 'pipeline' && (
              <div className="p-5 sm:p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  {/* Stage 1: Transport & BGP Origin */}
                  <motion.div 
                    animate={{ scale: activeStageHighlight === 1 ? 1.03 : 1, borderColor: activeStageHighlight === 1 ? '#c9a227' : '#2e2820' }}
                  ...
                  >
                    ...
                    <div className="space-y-1 text-[11px] font-['IBM_Plex_Mono',monospace] text-[#b9af9c]">
                      ...
                      <div>ASN: <strong className="text-[#ede6d8]">{originHop.asn || 'AS200548'}</strong></div>
                      <div className="flex items-center gap-1.5 mt-2">
                        ...
                        <span className={originHop.isTorExit || originHop.isProxyOrVpn ? 'text-[#ff8d7d] font-bold' : 'text-[#4ade80]'}>
                          {originHop.isTorExit ? 'Tor Exit Node Detected' : originHop.isProxyOrVpn ? 'Anonymizing Proxy' : 'Clean ISP Gateway'}
                        </span>
                      </div>
                    </div>
                  </motion.div>

                  {/* Stage 2: Transport Relay Conduit */}
                  <motion.div 
                    animate={{ scale: activeStageHighlight === 2 ? 1.03 : 1, borderColor: activeStageHighlight === 2 ? '#7fa3ba' : '#2e2820' }}
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="font-['IBM_Plex_Mono',monospace] text-[10.5px] text-[#7fa3ba] font-bold uppercase tracking-wider">
                        Stage 02 • Relay Trace
                      </span>
                      <Activity className="w-4 h-4 text-[#7fa3ba]" />
                    </div>
                    <div>
                      <div className="text-[11px] font-['IBM_Plex_Mono',monospace] text-[#8e8574]">Total MTA Hops</div>
                      <div className="text-[13px] font-mono font-bold text-[#ede6d8] mt-0.5">
                        {hops.length || 3} Validated Received Headers
                      </div>
                    </div>
                    <div className="space-y-1 text-[11px] font-['IBM_Plex_Mono',monospace] text-[#b9af9c]">
                      <div>Recipient MTA: <strong className="text-[#ede6d8]">{finalHop.by || 'mx.corporate-defense.net'}</strong></div>
                      <div>Transit Latency: <strong className="text-[#ede6d8]">~3.4 sec total</strong></div>
                      <div className="flex items-center gap-1.5 mt-2 text-[#4ade80]">
                        <CheckCircle2 className="w-3.5 h-3.5" />
                        <span>Reverse DNS PTR Matched</span>
                      </div>
                    </div>
                  </motion.div>

                  {/* Stage 3: Cryptographic Inspection */}
                  <motion.div 
                    animate={{ scale: activeStageHighlight === 3 ? 1.03 : 1, borderColor: activeStageHighlight === 3 ? '#eab308' : '#2e2820' }}
                  ...
                  >
                    ...
                    <div className="space-y-2 text-[11.5px] font-['IBM_Plex_Mono',monospace]">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-[#8e8574]">DMARC Policy:</span>
                        <span className={`px-1.5 py-0.2 rounded font-bold ${
                    ...
                    <div className="text-[10px] text-[#645c4e] font-['IBM_Plex_Mono',monospace] pt-1">
                      {isMalicious ? 'Zero-trust domain alignment violation' : 'Cryptographic RSA-2048 identity verified'}
                    </div>
                  </motion.div>

                  {/* Stage 4: MIME Deconstruction & Verdict */}
                  <motion.div 
                    animate={{ scale: activeStageHighlight === 4 ? 1.03 : 1, borderColor: activeStageHighlight === 4 ? '#b23a2e' : '#2e2820' }}
                  ...
                  >
                    ...
                    <div className="space-y-1 text-[11px] font-['IBM_Plex_Mono',monospace]">
                      <div className="text-[#ede6d8]">
                        Action: <strong>{isMalicious ? 'QUARANTINE / REJECT' : 'DELIVERED SAFE'}</strong>
                      </div>
                      <div className="text-[#8e8574] text-[10px]">
                        Payload: {isMalicious ? 'Credential harvester / Macro trojan' : 'Clean verified attachment'}
                      </div>
                    </div>
                  </motion.div>
                ...
                <div className="p-4 bg-[#1e1913] border border-[#3e3425] rounded flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      <h4 className="text-[14px] font-bold text-[#ede6d8]">
                        The Forensic Principle: Why the database record is immutable
                      </h4>
                      <p className="text-[13px] text-[#b9af9c] leading-relaxed max-w-[75ch]">
                        Attackers can forge display names like "CEO" or "PayPal Team" because standard email apps render whatever text is inside the quotes. But the internet TCP connection requires their physical server IP address to connect to our gateway. TraceXMail captures the raw socket packet, binds it to a SHA-256 evidence seal, and proves spoofing beyond dispute.
                      </p>
                    </div>
                  </div>
                  ...
                  <button
                    onClick={handleOpenCase}
                    className="px-4 py-2 rounded bg-[#2d2419] hover:bg-[#c9a227] hover:text-[#0b0a08] text-[#ede6d8] border border-[#4d3f2b] hover:border-[#c9a227] font-['IBM_Plex_Mono',monospace] text-[12px] font-bold transition-all cursor-pointer shrink-0"
                  >
                    Open Live Analysis →
                  </button>
                </div>
            ...
            {activeTab === 'crypto' && (
              <div className="p-5 sm:p-6 space-y-4 font-['IBM_Plex_Mono',monospace] text-[12px]">
                <div className="bg-[#100e0c] p-4 rounded border border-[#2e2820] space-y-3">
                  <div className="flex items-center justify-between text-[#c9a227] font-bold pb-2 border-b border-[#241f18]">
                    <span>1. SPF Verification (Sender Policy Framework - RFC7208)</span>
                  ...
                  <div className="text-[#b9af9c] space-y-1 text-[11.5px]">
                    <div>Client IP: <span className="text-[#ede6d8]">{originHop.ip || '185.220.101.5'}</span></div>
                    <div>Envelope From (Return-Path): <span className="text-[#ede6d8]">{headers['return-path'] || 'bounces@attacker-vps.com'}</span></div>
                    <div>DNS SPF Policy: <span className="text-[#ede6d8]">v=spf1 ip4:198.51.100.0/24 -all</span></div>
                    <div className="text-[#8e8574] text-[11px] pt-1">
                      {authResults?.spf?.status === 'PASS' 
                        ? '✓ Authoritative DNS TXT confirms client IP is authorized to transmit mail for this domain.' 
                        : '✗ Client IP is NOT permitted by the authoritative DNS SPF record. The email is forged.'}
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#100e0c] p-4 rounded border border-[#2e2820] space-y-3">
                  <div className="flex items-center justify-between text-[#c9a227] font-bold pb-2 border-b border-[#241f18]">
                    <span>2. DKIM Digital Signature (DomainKeys Identified Mail - RFC6376)</span>
                    <span className={authResults?.dkim?.status === 'PASS' ? 'text-[#4ade80]' : 'text-[#ff8d7d]'}>
                      Result: {authResults?.dkim?.status || (isMalicious ? 'FAIL (Invalid RSA Hash)' : 'PASS')}
                    </span>
                  </div>
                  <div className="text-[#b9af9c] space-y-1 text-[11.5px]">
                    <div>Header Selector: <span className="text-[#ede6d8]">s=202604 • d=paypal.com • a=rsa-sha256</span></div>
                    <div>Body Hash (bh=): <span className="text-[#ede6d8]">47DEQpj8HBSa+/TImW+5JCeuQeRkm5NMpJWZG3hSuFU=</span></div>
                    <div className="text-[#8e8574] text-[11px] pt-1">
                      {authResults?.dkim?.status === 'PASS'
                        ? '✓ Cryptographic RSA-2048 signature mathematically matches the public key in DNS. Message content intact.'
                        : '✗ Cryptographic signature missing or body hash mismatch. Content was modified or private key not possessed.'}
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#100e0c] p-4 rounded border border-[#2e2820] space-y-3">
                  <div className="flex items-center justify-between text-[#c9a227] font-bold pb-2 border-b border-[#241f18]">
                    <span>3. DMARC Alignment & Enforcement (RFC7489)</span>
                    <span className={authResults?.dmarc?.status === 'PASS' ? 'text-[#4ade80]' : 'text-[#ff8d7d]'}>
                      Result: {authResults?.dmarc?.status || (isMalicious ? 'FAIL (Strict Reject)' : 'PASS')}
                    </span>
                  </div>
                  <div className="text-[#b9af9c] space-y-1 text-[11.5px]">
                    <div>Header From Domain: <span className="text-[#ede6d8]">{headers['from'] || 'security@paypal.com'}</span></div>
                    <div>Enforced Policy: <span className="text-[#ede6d8]">p=reject; sp=reject; pct=100;</span></div>
                    <div className="text-[#8e8574] text-[11px] pt-1">
                      {authResults?.dmarc?.status === 'PASS'
                        ? '✓ Header From matches authenticated domain. Strict alignment achieved.'
                        : '✗ Domain alignment failed. Policy explicitly orders receiver to reject this transmission.'}
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Tab 3: Raw RFC822 Headers with Syntax Coloring */}
            {activeTab === 'raw_headers' && (
              <div className="p-4 sm:p-6 space-y-4">
                <div className="flex items-center justify-between text-[11px] font-['IBM_Plex_Mono',monospace] text-[#8e8574]">
                  <span>Raw RFC5322 Ingestion Stream (Tamper-Evident Capture):</span>
                  <span>Encoding: UTF-8 / CRLF</span>
                </div>
                <pre className="bg-[#0b0a08] p-4 rounded border border-[#252019] text-[#b9af9c] font-['IBM_Plex_Mono',monospace] text-[11.5px] leading-relaxed overflow-x-auto max-h-[380px] select-all">
{rawAnalysis.rawHeaders || `Received: from origin-vps.anonymizing-relay.bg (185.220.101.5)
    by mx01.enterprise-inbox.net with ESMTP (TraceXMail Guard)
    for <victim@yourcompany.com>; Sun, 15 Sep 2026 14:12:08 +0000
...
From: "PayPal Security Resolution Center" <security@paypal.com>
...
MIME-Version: 1.0
Content-Type: multipart/alternative; boundary="----=_Part_99182_1829182"
X-TraceX-Evidence-Seal: ${currentCase.evidence_hash || 'SHA256:4a8f9c102948271049281048201928471029481029'}
X-TraceX-Verdict: ${currentCase.severity} (Risk: ${currentCase.threat_score ?? 88})`}
                </pre>
              </div>
            )}
